...
renter1 = User.create!(phone_number: "+1 438 371 2345", email: "sarah@email.com", password: "123456", first_name: "Sarah", last_name: "Jou", renter: true)
renter2 = User.create!(phone_number: "+1 514 123 2345", email: "elodie@email.com", password: "123456", first_name: "Elodie", last_name: "Hall", renter: true)
renter2 = User.create!(phone_number: "+1 438 123 2345", email: "simon@email.com", password: "123456", first_name: "Simon", last_name: "Spat", renter: true)
renter3 = User.create!(phone_number: "+1 514 123 2345", email: "francesca@email.com", password: "123456", first_name: "Francesca", last_name: "Hall", renter: true)
renter4 = User.create!(phone_number: "+1 438 123 2345", email: "wince@email.com", password: "123456", first_name: "Wince", last_name: "Shum", renter: true)
renter5 = User.create!(phone_number: "+1 438 123 2345", email: "thomas@email.com", password: "123456", first_name: "Thomas", last_name: "Viaules", renter: true)
...
renter8 = User.create!(phone_number: "+1 438 123 2345", email: "arthur@email.com", password: "123456", first_name: "Arthur", last_name: "Prats", renter: true)
renter9 = User.create!(phone_number: "+1 514 123 2345", email: "daniel@email.com", password: "123456", first_name: "Daniel", last_name: "Lee", renter: true)
renter10 = User.create!(phone_number: "+1 514 123 2345", email: "boran@email.com", password: "123456", first_name: "Boran", last_name: "Zaza", renter: true)
renter11 = User.create!(phone_number: "+1 514 123 2345", email: "frederic@email.com", password: "123456", first_name: "Frederic", last_name: "Charest", renter: true)
renter12 = User.create!(phone_number: "+1 514 123 2345", email: "nicolas@email.com", password: "123456", first_name: "Nicolas", last_name: "Fraisse", renter: true)
...
unit1 = Unit.create!(user: renter1, building: building1, unit_number: 100, square_meters: 900.0, bathrooms: 1.5, bedrooms: 3.5, purchase_price: 400000, payment_method: "Interac", renewal_date: Date.new(2021,7,1), payment_date: 5, rent_amount: 1000)
unit2 = Unit.create!(user: renter2, building: building1, unit_number: 101, square_meters: 889.2, bathrooms: 1.5, bedrooms: 3.5, purchase_price: 300000, payment_method: "Interac", renewal_date: Date.new(2021,8,1), payment_date: 5, rent_amount: 1200)
unit3 = Unit.create!(user: renter3, building: building1, unit_number: 102, square_meters: 962.0, bathrooms: 1.5, bedrooms: 3.5, purchase_price: 200000, payment_method: "Cheque", renewal_date: Date.new(2021,9,1), payment_date: 1, rent_amount: 1000)
unit4 = Unit.create!(user: renter4, building: building1, unit_number: 103, square_meters: 921.0, bathrooms: 1.5, bedrooms: 3.5, purchase_price: 150000, payment_method: "Interac", renewal_date: Date.new(2021,6,1), payment_date: 1, rent_amount: 800)
unit5 = Unit.create!(user: renter5, building: building2, unit_number: 200, square_meters: 984.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 250000, payment_method: "Interac", renewal_date: Date.new(2021,7,1), payment_date: 5, rent_amount: 1400)
unit6 = Unit.create!(user: renter6, building: building2, unit_number: 201, square_meters: 901.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 200090, payment_method: "Interac", renewal_date: Date.new(2021,8,1), payment_date: 1, rent_amount: 1000)
unit7 = Unit.create!(user: renter7, building: building2, unit_number: 202, square_meters: 904.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 150000, payment_method: "Cheque", renewal_date: Date.new(2021,4,1), payment_date: 1, rent_amount: 1200)
unit8 = Unit.create!(user: renter8, building: building2, unit_number: 203, square_meters: 913.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 156000, payment_method: "Interac", renewal_date: Date.new(2021,5,1), payment_date: 1, rent_amount: 800)
unit9 = Unit.create!(user: renter10, building: building1, unit_number: 202, square_meters: 900.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 280000, payment_method: "Interac", renewal_date: Date.new(2021,8,1), payment_date: 5, rent_amount: 1200)
unit10 = Unit.create!(user: renter11, building: building2, unit_number: 101, square_meters: 900.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 200000, payment_method: "Interac", renewal_date: Date.new(2021,8,1), payment_date: 5, rent_amount: 1200)
unit11 = Unit.create!(user: renter12, building: building2, unit_number: 102, square_meters: 900.0, bathrooms: 1.0, bedrooms: 2.0, purchase_price: 250000, payment_method: "Interac", renewal_date: Date.new(2021,9,1), payment_date: 1, rent_amount: 1100)
...
task3 = Task.create!(building: building1, title: "Ants everywhere", description: "I woke up this morning and there is a colony of ants in my bathroom, please send help!", category: "Other", expense: 92.11, urgency: "Medium", unit: unit2, start_date: "2020-02-27", status: true)
task4 = Task.create!(building: building1, contractor: contractor5, title: "Repair the roof", description: "Water is dripping onto my bed", category: "Renovation", expense: 605.3, urgency: "Medium", unit: unit4, start_date: "2020-03-27", status: true)
task5 = Task.create!(building: building2, title: "Fridge is broken", description: "All of my food is warm", category: "Furniture", expense: 450, urgency: "Medium", unit: unit6, start_date: "2020-04-27", status: true)
task6 = Task.create!(building: building2, title: "The door bell doesn't work", description: "Door bell doesn't make a sound", category: "Other", expense: 40.02, urgency: "Medium", unit: unit8, start_date: "2020-05-27", status: true)
task7 = Task.create!(building: building2, contractor: contractor4, title: "The heater is broken", description: "Help me I am freezing", category: "Hydro", expense: 302.09, urgency: "Medium", unit: unit5, start_date: "2020-06-27", status: true)
